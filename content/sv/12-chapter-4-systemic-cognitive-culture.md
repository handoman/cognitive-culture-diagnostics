...
1. **Intervju som avbrott:** samtal i intervjusituationer upplevs som avbrott i en process—svar kan framstå som:
   - **Korthet:** korta.
   - **Abstraktion:** abstrakta.
   - **Logikdominans:** “överdrivet logiska”.
   - **Full körning:** eller långa och detaljerade (när flödesschemat körs färdigt).
2. **Affektfördröjning:** känslor uttrycks först när de semi‑analytiskt “blivit klara” → kan misstolkas som affektfattigdom.
3. **Teknisk semantik:** misstag, konflikter och relationsproblem beskrivs med teknisk semantik → kan misstolkas som låg Theory of Mind, trots att ToM är stark men icke‑narrativ.
...
2. **Känslouttryck:**
   ...
   - **Missförstånd:** “fördröjd affekt = affektfattigdom”.
3. **Intressen:**
   - **SCC:** systemiskt djupdrivna projekt → ofta breda.
   - **AST:** restriktiva intressen → ofta smala.
   - **Missförstånd:** “systemfokus = specialintresse”.
4. **Samtalsstil:**
   - **SCC:** struktur → lång exposé eller kort logikoutput.
   - **AST:** monologt drag.
   - **Missförstånd:** “långt svar = monologisering”.
5. **Konflikthantering:**
   - **SCC:** optimerar logik → “fixar problemet”.
   - **AST:** går till regel eller rutin.
   - **Missförstånd:** “logikstyrning = rigiditet”.
