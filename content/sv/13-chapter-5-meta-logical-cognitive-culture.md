...
1. **Duplex‑tänkande (double‑stack reasoning)**  
   ...
   - **Stack 1:** aktiv handling, verbal output, social interaktion  
...
4. **Högupplöst monitorering av andra**  
   Personer med MLCC är ofta mycket skickliga på:
   - att tolka subtila signaler  
   - att upptäcka diskrepanser  
   - att känna av intern osäkerhet hos andra  
   - att förutse reaktioner  

5. **Minimal friktion i komplexa miljöer — maximal friktion i enkla**  
   MLCC trivs vid hög komplexitet men tappar funktion i triviala eller repetitiva sammanhang.

6. **Minimal extern valideringsdrift**  
...
**MLCC‑personens interna process:**
- **Stack 1:** “Svara korrekt och relevant.”
- **Stack 2:** “Vilken definition av social situation avser han? Vad är syftet? Han söker ett exempel. Undvik överladdning. Strukturera.”
...
1. **Formaliserat språk**  
   - **AST:** bokstavlighet, regelstyrt språk  
   - **MLCC:** meta‑logiskt språk för effektivitet och precision  

2. **Låg spontan affekt**  
   - **AST:** begränsad affektgenerering  
   - **MLCC:** affekt filtreras genom metakognition → latens före uttryck  

3. **Detaljfokus**  
   - **AST:** perceptuell detaljdominans  
   - **MLCC:** systemoptimering — detaljer evalueras för funktion  

4. **Direkt kommunikation**  
   - **AST:** begränsad social modulering  
   - **MLCC:** preferens för semantisk effektivitet  

5. **“Specialintressen”**  
   - **AST:** monofokala intressen  
   - **MLCC:** meta‑intressen — processer, strukturer, mekanismer, logik  
